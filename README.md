...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-fno8woo.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-fno8woo.containers.anotherwebservice.com/
...
```
git clone git@github.com:ShadityZ/container-fno8woo.git
cd container-fno8woo
```
...
```
docker attach container-fno8woo
```
